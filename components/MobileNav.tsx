...
/**
 * Settings are open to guests too (see app/settings/page.tsx), but the desktop
 * Navbar's ⚙️ link is hidden below 768px, so this bottom bar is the only way a
 * mobile visitor — signed in or not — can reach them.
 */
...
export default function MobileNav() {
  ...
  const tabs = [...TABS, getSettingsTab(), getProfileTab(session)]
